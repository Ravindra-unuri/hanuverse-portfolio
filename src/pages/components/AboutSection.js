    ...
    return (
        <section id="about" className=" bg-white py-16 px-6">
            <div className="max-w-5xl mx-auto text-center">
                <h2 className="text-4xl text-black font-bold text-navi-blue mb-6">About Hanuverse</h2>
                ...
                <p className="text-md text-gray-400 dark:text-gray-400 mb-6">
                ...
                <div className="mt-8">
                    <p className="text-base text-black font-medium text-navi-blue">
