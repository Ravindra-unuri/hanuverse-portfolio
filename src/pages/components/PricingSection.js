            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow hover:shadow-lg transition">
                        ...
                        <div className="text-3xl font-semibold text-orange-500 mb-4">₹399</div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow hover:shadow-lg transition">
                        ...
                        <p className="text-[#2E2E2E] dark:text-gray-300 mb-4">Starts at</p>
                        <div className="text-3xl font-semibold text-orange-500 mb-4">₹799</div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow hover:shadow-lg transition">
                        ...
                        <p className="text-[#2E2E2E] dark:text-gray-300 mb-4">Starts at</p>
                        <div className="text-3xl font-semibold text-orange-500 mb-4">₹4,999</div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow hover:shadow-lg transition">
                        ...
                        <p className="text-[#2E2E2E] dark:text-gray-300 mb-4">Starts at</p>
                        <div className="text-3xl font-semibold text-orange-500 mb-4">₹4,999/2 reel editing</div>
